...
fornavn = random.choice(nouns)
# print(fornavn)

#print(random.choice(nouns).title() + random.choice(adjectives).title())

firstname = random.choice(nouns).title()
lastname = random.choice(adjectives).title()
print("{} {}".format(firstname, lastname))

#In a oneliner
print("{first_name} {last_name}".format( first_name = random.choice(nouns).title(), last_name = random.choice(adjectives).title() ) )
